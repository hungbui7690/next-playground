...
const SingleDrink = async ({ params }) => {
  ...
  return (
    <div>
      ...
      {/* 2. Remote Image -> width & height to prevent image shifts -> this will return errors since NextJS cannot access to remote files during build process -> need to set up config */}
      <Image
        src={imgSrc}
        width={300}
        height={300}
